...
import CustomUI.HelviticaLight;
import Network.AppRequestQueue;
import Network.ErrorHandler;
import Network.JsonParser.EmailHandler;
import Utils.BundleKey;
import Utils.DataStore;
import Utils.RequestParameterKey;
...
@BindView(R.id.sign_in_text) HelviticaLight mSignIn;
...
private void CheckEmail() {
        ...
        //wrong Email Format
                try {
                        ...
                        Log.d("Exception ","exception in settng up values");
                }
        }
}
